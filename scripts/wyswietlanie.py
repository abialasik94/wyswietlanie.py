...
def mapxPrint(data, **kwargs):
    ...
    with open(sciezka_output + "NowaKompozycjaBDOT10k_NightVision_Wzor.csv", "w", encoding='utf-8') as text_file:
        text_file.write(str(output))

nazwaPliku = "NowaKompozycjaBDOT10k_NightVision_Wzor.mapx"
